terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "tbstoragealexsklr"
    container_name       = "tbcontaineralexsklr"
...
# Generate random integer to create unique name globally
...
# Create MSSQL Server Firewall Rule
